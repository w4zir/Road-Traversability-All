...
int main(int argc, char *argv[])
{
	...
	std::string prmFolder = "/home/khan/phd_ws/traversability/prm/safe_paths/";
	std::string adjFolder = "/home/khan/phd_ws/traversability/adjacency/safe_paths/";
	std::string fileStartName = "road_";
